...
public class Deck {
    ...
    private void addAllCards() throws IOException{
        ...
        level1.push(new GizmoCard(MarbleColor.BLUE, 1,1, GizmoType.BUILD, "buildGet1VictoryPoint", 1, ImageIO.read(Objects.requireNonNull(Deck.class.getResource("/Images/GizmoCardsTrimmed/Blue1Rank1.png"))), MarbleColor.BLACK, GizmoLevel.LEVEL1));
        ...
        level3.push(new GizmoCard(MarbleColor.BLUE, 5,5, GizmoType.CONVERTOR, "convert1or2to2", 5, ImageIO.read(Objects.requireNonNull(Deck.class.getResource("/Images/GizmoCardsTrimmed/Blue1Rank3.png"))), MarbleColor.BLACK, MarbleColor.RED, GizmoLevel.LEVEL3));
        ...
        level1.push(new GizmoCard(MarbleColor.RED, 1, 1, GizmoType.BUILD, "buildGet1VictoryPoint",1, ImageIO.read(Objects.requireNonNull(Deck.class.getResource("/Images/GizmoCardsTrimmed/Red1Rank1.png"))), MarbleColor.YELLOW, GizmoLevel.LEVEL1));
        ...
        level1.push(new GizmoCard(MarbleColor.RED, 1, 1, GizmoType.BUILD, "buildPick1From6", 2, ImageIO.read(Objects.requireNonNull(Deck.class.getResource("/Images/GizmoCardsTrimmed/Red2Rank1.png"))), MarbleColor.BLACK, GizmoLevel.LEVEL1));
        ...
        level2.push(new GizmoCard(MarbleColor.RED, 3, 3, GizmoType.CONVERTOR, "convert1to2", 1, ImageIO.read(Objects.requireNonNull(Deck.class.getResource("/Images/GizmoCardsTrimmed/Red3Rank2.png"))), MarbleColor.BLACK, GizmoLevel.LEVEL2));
        ...
        level2.push(new GizmoCard(MarbleColor.RED, 2, 2, GizmoType.CONVERTOR, "convert1Or2ToAny", 1, ImageIO.read(Objects.requireNonNull(Deck.class.getResource("/Images/GizmoCardsTrimmed/Red4Rank2.png"))), MarbleColor.YELLOW, GizmoLevel.LEVEL2));
        ...
        level1.push(new GizmoCard(MarbleColor.YELLOW,1,4, GizmoType.BUILD, "buildPick1From6",2, ImageIO.read(Objects.requireNonNull(Deck.class.getResource("/Images/GizmoCardsTrimmed/Yellow2Rank1.png"))), MarbleColor.RED, GizmoLevel.LEVEL1));
        ...
        level3.push(new GizmoCard(MarbleColor.YELLOW, 6,6, GizmoType.BUILD, "buildThisOrThatBuildTier1For0", 8, ImageIO.read(Objects.requireNonNull(Deck.class.getResource("/Images/GizmoCardsTrimmed/Yellow4Rank3.png"))), MarbleColor.BLUE, MarbleColor.BLACK, GizmoLevel.LEVEL3));
        ...
        level2.push(new GizmoCard(MarbleColor.YELLOW, 1,1, GizmoType.CONVERTOR, "convert1ToAny", 1, ImageIO.read(Objects.requireNonNull(Deck.class.getResource("/Images/GizmoCardsTrimmed/Yellow10Rank1.png"))), MarbleColor.BLUE, GizmoLevel.LEVEL2));
        ...
        level3.push(new GizmoCard(MarbleColor.ANY,7,0, GizmoType.UPGRADE, "upgradeVPEqualToNumOfMarbles", 1, ImageIO.read(Objects.requireNonNull(Deck.class.getResource("/Images/GizmoCardsTrimmed/MultiColor1Rank3.png"))), GizmoLevel.LEVEL3));
        level3.push(new GizmoCard(MarbleColor.ANY, 7,0, GizmoType.UPGRADE, "upgradeVPEqualToNumOfVPTokens", 3, ImageIO.read(Objects.requireNonNull(Deck.class.getResource("/Images/GizmoCardsTrimmed/MultiColor2Rank3.png"))), GizmoLevel.LEVEL3));
        level3.push(new GizmoCard(MarbleColor.ANY, 7,0, GizmoType.UPGRADE, "upgradeVPEqualToNumOfMarbles", 1, ImageIO.read(Objects.requireNonNull(Deck.class.getResource("/Images/GizmoCardsTrimmed/MultiColor3Rank3.png"))), GizmoLevel.LEVEL3));
        level3.push(new GizmoCard(MarbleColor.ANY, 7,0, GizmoType.UPGRADE, "upgradeVPEqualToNumOfVPTokens", 3, ImageIO.read(Objects.requireNonNull(Deck.class.getResource("/Images/GizmoCardsTrimmed/MultiColor4Rank3.png"))), GizmoLevel.LEVEL3));
