...
public class Deck {
    ...
    private void addAllCards() throws IOException{
        ...
        level3.push(new GizmoCard(MarbleColor.BLUE, 4,6, GizmoType.UPGRADE, "upgradenoresearching", 6, ImageIO.read(Objects.requireNonNull(Deck.class.getResource("/Images/GizmoCardsTrimmed/Blue6Rank3.png"))), GizmoLevel.LEVEL3));
        ...
        level3.push(new GizmoCard(MarbleColor.RED, 4, 4, GizmoType.CONVERTOR, "convert1to1", 1, ImageIO.read(Objects.requireNonNull(Deck.class.getResource("/Images/GizmoCardsTrimmed/Red2Rank3.png"))), MarbleColor.ANY, GizmoLevel.LEVEL3));
        ...
        level2.push(new GizmoCard(MarbleColor.RED, 3, 3, GizmoType.CONVERTOR, "convert1to2any", 1, ImageIO.read(Objects.requireNonNull(Deck.class.getResource("/Images/GizmoCardsTrimmed/Red3Rank2.png"))), MarbleColor.BLACK, GizmoLevel.LEVEL2));
        ...
        level3.push(new GizmoCard(MarbleColor.RED, 4, 7, GizmoType.UPGRADE, "upgradenoresearching", 6, ImageIO.read(Objects.requireNonNull(Deck.class.getResource("/Images/GizmoCardsTrimmed/Red8Rank3.png"))), GizmoLevel.LEVEL3));
